      ...
      builder: (_, snapshot) {
        ...
        return _buildPersonList(
          ...
          actionItems: [
            ...
            _buildPopupItem('President', Icons.person, Colors.grey),
            _buildPopupItem('Vice President', Icons.person, Colors.grey),
            _buildPopupItem('General Secretary', Icons.person, Colors.grey),
            _buildPopupItem('Joint Secretary', Icons.person, Colors.grey),
            _buildPopupItem('Assistant Secretary', Icons.person, Colors.grey),
            _buildPopupItem('Organizing Secretary', Icons.person, Colors.grey),
            _buildPopupItem('Treasurer', Icons.attach_money, Colors.green),
            _buildPopupItem('Financial Controller', Icons.attach_money, Colors.green),
            _buildPopupItem('Event Manager', Icons.event, Colors.purple),
            _buildPopupItem('Event Coordinator', Icons.event, Colors.purple),
            _buildPopupItem('Logistics Head', Icons.local_shipping, Colors.orange),
            _buildPopupItem('Operations Manager', Icons.settings, Colors.orange),
            _buildPopupItem('Public Relations Officer', Icons.campaign, Colors.blue),
            _buildPopupItem('Communications Officer', Icons.message, Colors.blue),
            _buildPopupItem('Media Coordinator', Icons.perm_media, Colors.blue),
            _buildPopupItem('Social Media Manager', Icons.share, Colors.blue),
            _buildPopupItem('Creative Director', Icons.lightbulb, Colors.purple),
            _buildPopupItem('Design Head', Icons.brush, Colors.purple),
            _buildPopupItem('Technical Head', Icons.engineering, Colors.grey),
            _buildPopupItem('Content Creator', Icons.edit, Colors.grey),
            _buildPopupItem('Graphic Designer', Icons.image, Colors.purple),
            _buildPopupItem('Webmaster', Icons.web, Colors.blue),
            _buildPopupItem('Photographer', Icons.camera_alt, Colors.brown),
            _buildPopupItem('Videographer', Icons.videocam, Colors.brown),
            _buildPopupItem('Membership Coordinator', Icons.group, Colors.blueGrey),
            _buildPopupItem('Outreach Coordinator', Icons.send, Colors.blueGrey),
            _buildPopupItem('Partnership Coordinator', Icons.handshake, Colors.blueGrey),
            _buildPopupItem('Fundraising Officer', Icons.monetization_on, Colors.green),
            _buildPopupItem('Alumni Relations Officer', Icons.school, Colors.blue),
            _buildPopupItem('Cultural Secretary', Icons.theater_comedy, Colors.orange),
            _buildPopupItem('Sports Secretary', Icons.sports_soccer, Colors.orange),
            _buildPopupItem('Academic Head', Icons.book, Colors.indigo),
            _buildPopupItem('Research Head', Icons.science, Colors.indigo),
            _buildPopupItem('Training Head', Icons.fitness_center, Colors.teal),
            _buildPopupItem('Welfare Officer', Icons.health_and_safety, Colors.teal),
            _buildPopupItem('Equity Officer', Icons.balance, Colors.teal),
            _buildPopupItem('Faculty Advisor', Icons.person, Colors.blueGrey),
            _buildPopupItem('Mentor', Icons.person_outline, Colors.blueGrey),
            _buildPopupItem('Legal Advisor', Icons.gavel, Colors.redAccent),
            _buildPopupItem('Auditor', Icons.assessment, Colors.deepOrange),
            _buildPopupItem('Project Manager', Icons.assignment, Colors.orange),
            _buildPopupItem('Volunteer Coordinator', Icons.volunteer_activism, Colors.green),
            _buildPopupItem('General Member', Icons.person, Colors.grey),
            _buildPopupItem('Executive Member', Icons.person, Colors.grey),
            _buildPopupItem('Remove', Icons.person_remove, Colors.red),
          ],
